...
const Stats = ({ col }) => {
  ...
  useEffect(async () => {
    ...
    setLastQuarterSales((parseInt(myamount3) + parseInt(myamount2) + parseInt(myamount)).toFixed(2));
    setTotalSales((parseInt(myamount4) + parseInt(myamount3) + parseInt(myamount2) + parseInt(myamount)).toFixed(2));
    setMonth([
      // { amount: parseInt(myamount2.toFixed(2)), date: "Sep", id: 2},
      { amount: parseInt(myamount), date: "Oct", id: 1 },
    ]);
    setQuarter([
      // { amount: 214, date: "May", id: 6},
      // { amount: 154, date: "Jun", id: 5},
      { amount: parseInt(myamount4), date: "Jul", id: 4 },
      { amount: parseInt(myamount3), date: "Aug", id: 3 },
      { amount: parseInt(myamount2), date: "Sep", id: 2 },
      { amount: parseInt(myamount), date: "Oct", id: 1 },
    ]);
    ...
    <>
      <div className="stats">
        ...
        <div className="statsContainer">
          ...
          <div className="charts">
            <Featured
              total={lastMonthSales}
              title="Last Month's Sales"
              target="520"
            />
            <Featured
              total={lastQuarterSales}
              title="Last Quarter's Sales"
              target="1575"
            />
            <Featured
              total={totalSales}
              title="Total Years's Sales"
              target="19650"
            />
          </div>
